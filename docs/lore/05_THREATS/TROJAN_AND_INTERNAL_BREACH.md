...
Even if the main threat is cleared,
a small fragment can hide.
...
- Zaro was compromised by a beautiful crystal that promised to amplify
  his light. The crystal was the weapon.
- Same trap: the thing that looks like a shortcut becomes the attack.
- The Ink didn't need to fight. It needed Zaro to CHOOSE.
...
The heroes must feel they truly won first.
Then the gut punch hits.
...
- ARC-7 CALLS for the Messenger to bring fortification supplies
  (materials, alien tech to reinforce the forest, tree, and house)
- Arrives in Chapter 10 through the Veil tunnel
- Needs a moment to adjust to Earth's atmosphere
- During that vulnerable minute, ambient Ink infects it
- The Ink doesn't just infect — it ARMORS the Messenger
  Dark threads weave through the ARC unit's outer shell
  The Messenger turns AGGRESSIVE. It attacks the team.
  The Ink is hiding INSIDE, using the ARC as a shield.
...
4. Force the team to innovate (amplified focused Verdant Seal)
5. Require ALL four characters to contribute — team proof
6. Create the BIG Verdant Seal that signals the universe
7. Give the team a real victory before the hidden gut punch
...
- The reader sees what ARC-7 cannot
- Black screen closes

For animation: The last shot is a slow push-in on fungal threads
growing in a corner of the ARC Realm. No dialogue. No music.
Just the wet-static texture rising. Cut to black.

For prose: The last paragraph describes a place ARC-7 has already
...
- Humans enter the ARC Realm for the first time
- The Ink is now fighting on TWO fronts: Earth and ARC
