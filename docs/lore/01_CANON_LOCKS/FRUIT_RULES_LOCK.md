# FRUIT RULES (CANON LOCK — April 2026)
...
3. THE TREE IS THE TREASURY. Everything comes back to the tree.
   Zaro collects fruits and stores them inside his home,
...
5. RECOVERY IS GRADUAL AND TOP-DOWN. After the breach:
   ...
   - Middle branches recover over weeks
   - Bottom branches (most damaged, closest to fire) recover LAST
   - You can read the recovery timeline by looking at the tree top to bottom
   - The bottom fruits recovering is the FINAL sign the tree is truly back
